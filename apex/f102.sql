...
,p_release=>'24.2.5'
,p_default_workspace_id=>8129432395598816
,p_default_application_id=>102
,p_default_id_offset=>8142687734203408
,p_default_owner=>'APPTESTEXAMPLE'
);
end;
/
 
prompt APPLICATION 102 - Sample Calendar
--
-- Application Export:
--   Application:     102
--   Name:            Sample Calendar
...
,p_owner=>nvl(wwv_flow_application_install.get_schema,'APPTESTEXAMPLE')
...
,p_application_group=>wwv_flow_imp.id(35331638635976710)
...
,p_authentication_id=>wwv_flow_imp.id(8211377037885896731)
...
,p_navigation_list_id=>wwv_flow_imp.id(1715157552756109941)
,p_navigation_list_position=>'SIDE'
,p_navigation_list_template_id=>2467739217141810545
,p_nav_list_template_options=>'#DEFAULT#:js-defaultCollapsed:js-navCollapsed--hidden:t-TreeNav--styleA'
,p_css_file_urls=>'#IMAGE_PREFIX#pkgapp_ui/css/5.0#MIN#.css'
,p_nav_bar_type=>'LIST'
,p_nav_bar_list_id=>wwv_flow_imp.id(1715172138237219293)
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(800269143775150185)
,p_name=>'Standard Calendars'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800269375938150186)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800269795689150187)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800270123706150187)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800270610780150187)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800270959743150188)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(638332697952815936)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(800274357641203012)
,p_name=>'Calendars and Dynamic Actions'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800274566018203013)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800274969875203013)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800275343622203013)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800310186652571813)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(988840640599664468)
,p_list_item_display_sequence=>50
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(800279521499261016)
,p_name=>'Calendars and Javascript'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800279728418261017)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800280168551261018)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800280538845261018)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(804378150253489955)
,p_list_item_display_sequence=>40
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(800285161730306214)
,p_name=>'Calendar Styling'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800285403957306214)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800285730435306215)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(858060446226512830)
,p_name=>'Custom Calendar Initialization'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(858060643828512831)
,p_list_item_display_sequence=>10
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1715157552756109941)
,p_name=>'Navigation Menu'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796311047612740048)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796380820878021211)
,p_list_item_display_sequence=>90
,p_list_item_link_text=>'Monthly Calendar: Projects'
,p_list_item_link_target=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(796311047612740048)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(786998281566288429)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(793590799961576747)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796317203472759688)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800200511040517730)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(627114850438819752)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796323052029802086)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796328763497814158)
,p_list_item_display_sequence=>140
,p_list_item_link_text=>'Calendar and Report'
,p_list_item_link_target=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(796323052029802086)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'51'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796342137043827905)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796357408259907383)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800302388626526498)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(901962620719582491)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796381413318047522)
,p_list_item_display_sequence=>40
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796382217414072173)
,p_list_item_display_sequence=>190
,p_list_item_link_text=>'Custom Navigation'
,p_list_item_link_target=>'f?p=&APP_ID.:71:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(796381413318047522)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'71'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796408729529264276)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796509594615437800)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(804333298439939934)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(858058331439499486)
,p_list_item_display_sequence=>60
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(858044767223375598)
,p_list_item_display_sequence=>300
,p_list_item_link_text=>'Weekly schedule'
,p_list_item_link_target=>'f?p=&APP_ID.:111:&SESSION.::&DEBUG.::::'
,p_parent_list_item_id=>wwv_flow_imp.id(858058331439499486)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'111'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796479645500123685)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796480456785131463)
,p_list_item_display_sequence=>230
,p_list_item_link_text=>'Custom CSS Classes'
,p_list_item_link_target=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.'
,p_parent_list_item_id=>wwv_flow_imp.id(796479645500123685)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
,p_list_item_current_for_pages=>'91'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(796487282098218368)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1718377965144611383)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1715172138237219293)
,p_name=>'Navigation Bar (Top)'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1715172319688219295)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1715172715037219389)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1715173106905219389)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Sign Out'
,p_list_item_link_target=>'&LOGOUT_URL.'
,p_parent_list_item_id=>wwv_flow_imp.id(1715172715037219389)
,p_list_item_current_type=>'TARGET_PAGE'
);
end;
/
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(1880504496549859271)
,p_name=>'Administration'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1880504815600859274)
,p_list_item_display_sequence=>10
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(1880505165024859275)
,p_list_item_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(2593837821184695807)
,p_name=>'Home Page List'
,p_list_status=>'PUBLIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3428889809644231374)
,p_list_item_display_sequence=>10
,p_list_item_link_text=>'Standard Calendars'
,p_list_item_link_target=>'f?p=&APP_ID.:30:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-calendar'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3425658025791671307)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3425658040619671307)
,p_list_item_display_sequence=>30
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(3425658177768671307)
,p_list_item_display_sequence=>40
,p_list_item_link_text=>'Calendar Styling'
,p_list_item_link_target=>'f?p=&APP_ID.:90:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'fa-paint-brush'
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(800239131306840794)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Administration'
,p_list_item_link_target=>'f?p=&APP_ID.:15:&SESSION.::&DEBUG.::::'
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(548401921667233846)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(548402055907233856)
...
wwv_flow_imp_shared.create_app_static_file(
 p_id=>wwv_flow_imp.id(548402352720233893)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(17941215238262264)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>186626129
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(19462418686781579)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(19492097178742926)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>37167665069464
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(19492519153742927)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(19515251688588542)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(117786774467151160)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(139339186903642042)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(141155988559740722)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(194071593077769076)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(624725187221970805)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37166093867981
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1139170713478768794)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1785534568569653664)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1852234709635935764)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1938149711413881810)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(3217471416497531041)
,p_icon_sequence=>10
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(3217470811995529714)
,p_icon_sequence=>20
,p_icon_subtext=>'Help'
...
wwv_flow_imp_shared.create_icon_bar_item(
 p_id=>wwv_flow_imp.id(8211376549203896729)
,p_icon_sequence=>30
...
wwv_flow_imp_shared.create_flow_process(
 p_id=>wwv_flow_imp.id(1573372321339885795)
...
wwv_flow_imp_shared.create_toplevel_tab(
 p_id=>wwv_flow_imp.id(3183423395212982134)
,p_tab_set=>'TS1'
,p_tab_sequence=>10
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2590144225528110366)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(796306620013716604)
,p_lov_name=>'SESSION_TYPES'
,p_lov_query=>'.'||wwv_flow_imp.id(796306620013716604)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(796306983524716604)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Business'
,p_lov_return_value=>'BUSINESS'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(796307322889716606)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>'Technical'
,p_lov_return_value=>'TECHNICAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(796307735230716606)
,p_lov_disp_sequence=>3
,p_lov_disp_value=>'General Session'
,p_lov_return_value=>'GENERAL'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(796308194084716606)
,p_lov_disp_sequence=>4
,p_lov_disp_value=>'Break'
,p_lov_return_value=>'BREAK'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(796308576332716607)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(340904421072829843)
,p_lov_name=>'STATUS'
,p_lov_query=>'.'||wwv_flow_imp.id(340904421072829843)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(340904654782829844)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>'Active'
,p_lov_return_value=>'ACTIVE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(340905139743829844)
,p_lov_disp_sequence=>2
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(2669199507631482917)
,p_lov_name=>'VALID STATUS CODES'
,p_lov_query=>'.'||wwv_flow_imp.id(2669199507631482917)||'.'
,p_location=>'STATIC'
,p_version_scn=>1089078457
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2669199715376482920)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Closed'
,p_lov_return_value=>'Closed'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2669199900087482928)
,p_lov_disp_sequence=>20
,p_lov_disp_value=>'On-Hold'
,p_lov_return_value=>'On-Hold'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2669200095650482928)
,p_lov_disp_sequence=>30
,p_lov_disp_value=>'Open'
,p_lov_return_value=>'Open'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(2669200305354482928)
...
wwv_flow_imp_shared.create_menu(
 p_id=>wwv_flow_imp.id(8211378338736896741)
,p_name=>' Breadcrumb'
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(627116914917819800)
,p_parent_id=>wwv_flow_imp.id(800273512097182941)
,p_short_name=>'Faceted Search: Projects'
,p_link=>'f?p=&APP_ID.:36:&APP_SESSION.::&DEBUG.:::'
,p_page_id=>36
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800252008072932343)
,p_parent_id=>wwv_flow_imp.id(800273512097182941)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800252244646944188)
,p_parent_id=>wwv_flow_imp.id(800273512097182941)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800252445984946231)
,p_parent_id=>wwv_flow_imp.id(800273512097182941)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800252652724947935)
,p_parent_id=>wwv_flow_imp.id(800273512097182941)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800252831228949100)
,p_parent_id=>wwv_flow_imp.id(800273512097182941)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800253083073952953)
,p_parent_id=>wwv_flow_imp.id(800278560175246069)
,p_short_name=>'Calendar and Report'
,p_link=>'f?p=&APP_ID.:51:&SESSION.::&DEBUG.:::'
,p_page_id=>51
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800253253220954715)
,p_parent_id=>wwv_flow_imp.id(800278560175246069)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800253479157956880)
,p_parent_id=>wwv_flow_imp.id(800278560175246069)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800253677293959203)
,p_parent_id=>wwv_flow_imp.id(800284701195296670)
,p_short_name=>'Custom Navigation'
,p_link=>'f?p=&APP_ID.:71:&SESSION.::&DEBUG.:::'
,p_page_id=>71
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800253832470961403)
,p_parent_id=>wwv_flow_imp.id(800284701195296670)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800254098206962525)
,p_parent_id=>wwv_flow_imp.id(800284701195296670)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800254226609964863)
,p_parent_id=>wwv_flow_imp.id(800288725331328747)
,p_short_name=>'Custom CSS Classes'
,p_link=>'f?p=&APP_ID.:91:&SESSION.::&DEBUG.:::'
,p_page_id=>91
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(800254466252966539)
,p_parent_id=>wwv_flow_imp.id(800288725331328747)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(835463590849892757)
,p_parent_id=>wwv_flow_imp.id(800278560175246069)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(858063079136534325)
,p_short_name=>'Custom Calendar Initialization'
,p_link=>'f?p=&APP_ID.:110:&SESSION.::&DEBUG.:::'
,p_page_id=>110
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(858063312281537590)
,p_parent_id=>wwv_flow_imp.id(858063079136534325)
,p_short_name=>'Custom weekly schedule'
,p_link=>'f?p=&APP_ID.:111:&SESSION.::&DEBUG.:::'
,p_page_id=>111
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(903153917433636342)
,p_parent_id=>wwv_flow_imp.id(800284701195296670)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1321180922977617858)
,p_short_name=>'Mini Calendar'
,p_link=>'f?p=&APP_ID.:13:&SESSION.::&DEBUG.:::'
,p_page_id=>13
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1321181596140617862)
,p_parent_id=>wwv_flow_imp.id(1321180922977617858)
,p_short_name=>'&P14_PROJECT.'
,p_link=>'f?p=&APP_ID.:14:&SESSION.::&DEBUG.:::'
,p_page_id=>14
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1880022752341375018)
,p_parent_id=>wwv_flow_imp.id(1880504235281859267)
,p_short_name=>'Application Theme Style'
,p_link=>'f?p=&APP_ID.:8:&SESSION.::&DEBUG.:::'
,p_page_id=>8
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(1880504235281859267)
,p_short_name=>'Administration'
,p_link=>'f?p=&APP_ID.:15:&SESSION.'
,p_page_id=>15
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2588327123549860653)
,p_short_name=>'Calendar Entry'
,p_link=>'f?p=&APP_ID.:3:&SESSION.::&DEBUG.:::'
,p_page_id=>3
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2588735800081944194)
,p_short_name=>'Time Line'
,p_link=>'f?p=&APP_ID.:4:&SESSION.::&DEBUG.:::'
,p_page_id=>4
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2601458802637782994)
,p_parent_id=>wwv_flow_imp.id(1880504235281859267)
...
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2603070504331002914)
,p_parent_id=>wwv_flow_imp.id(2601458802637782994)
,p_short_name=>'Report'
,p_link=>'f?p=&APP_ID.:7:&SESSION.'
,p_page_id=>7
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2668794897264419934)
,p_short_name=>'Project Due Dates'
,p_link=>'f?p=&APP_ID.:9:&SESSION.::&DEBUG.:::'
,p_page_id=>9
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(2668795226940419935)
,p_parent_id=>wwv_flow_imp.id(2668794897264419934)
,p_short_name=>'Project Detail'
,p_link=>'f?p=&FLOW_ID.:10:&SESSION.'
,p_page_id=>10
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(3258247714475930558)
,p_short_name=>'Help'
,p_link=>'f?p=&FLOW_ID.:12:&SESSION.'
,p_page_id=>12
);
wwv_flow_imp_shared.create_menu_option(
 p_id=>wwv_flow_imp.id(8211378750584896744)
,p_short_name=>'Home'
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(3182362199408401287)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653320653603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653364203603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653471110603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653573255603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Expand'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653694411603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653798077603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160653945671603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160654042636603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160654048727603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160654182792603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160654249679603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160654420180603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(160654527470603825)
,p_plug_template_id=>wwv_flow_imp.id(3182362199408401287)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_theme(
 p_id=>wwv_flow_imp.id(1715114613779988848)
,p_theme_id=>42
...
,p_default_header_template=>wwv_flow_imp.id(1715079913429988731)
,p_default_footer_template=>wwv_flow_imp.id(1715079913429988731)
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35808288742600494)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35812264195600496)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35814303519600497)
,p_theme_id=>42
,p_name=>'ICON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35817505446600499)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35825835522600505)
,p_theme_id=>42
,p_name=>'DISPLAY_MODE'
,p_display_name=>'Display Mode'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35835758099600511)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(35839770160600514)
,p_theme_id=>42
,p_name=>'COLOR_ACCENTS'
,p_display_name=>'Color Accents'
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988566888499941336)
,p_theme_id=>142
,p_name=>'ALERT_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988567205334941336)
,p_theme_id=>142
,p_name=>'DISPLAY_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988569055070941341)
,p_theme_id=>142
,p_name=>'REGION_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988569417333941341)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988571211850941344)
,p_theme_id=>142
,p_name=>'BODY_HEIGHT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988571673151941344)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988571935369941345)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988573074077941345)
,p_theme_id=>142
,p_name=>'REGION_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988574053096941346)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988574725588941347)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988575065280941347)
,p_theme_id=>142
,p_name=>'LAYOUT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988577118723941352)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988577577621941352)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988577878529941352)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988579293291941355)
,p_theme_id=>142
,p_name=>'LAYOUT'
,p_display_name=>'Layout'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988580211637941357)
,p_theme_id=>142
,p_name=>'BADGE_SIZE'
,p_display_name=>'Badge Size'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988581634850941358)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988582773576941359)
,p_theme_id=>142
,p_name=>'ICON_STYLE'
,p_display_name=>'Icon Style'
,p_display_sequence=>1
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988584619523941364)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988585727015941366)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988586456848941368)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988587745545941371)
,p_theme_id=>142
,p_name=>'BUTTON_TYPE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988588077907941371)
,p_theme_id=>142
,p_name=>'SPACING_LEFT'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988588407965941371)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988588759204941371)
,p_theme_id=>142
,p_name=>'BUTTON_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988589050284941371)
,p_theme_id=>142
,p_name=>'BUTTON_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988589589180941371)
,p_theme_id=>142
,p_name=>'BUTTON_SET'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988590326227941371)
,p_theme_id=>142
,p_name=>'BUTTON_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988590843625941372)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988591364712941372)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988591628379941372)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988591971163941372)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(988592284906941372)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1052699939960301265)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1075453071431384006)
,p_theme_id=>142
,p_name=>'CURRENT_PAGE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1234662046398955990)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1234667844030956002)
,p_theme_id=>142
,p_name=>'LIST_STYLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1271513835090183875)
,p_theme_id=>142
,p_name=>'DIALOG_SIZE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1271516262053183877)
,p_theme_id=>142
,p_name=>'DISPLAY'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1271535378753183902)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1358290175529205783)
,p_theme_id=>142
,p_name=>'LABEL_WIDTH'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1361817321763563157)
,p_theme_id=>142
,p_name=>'REGION_TITLE'
...
wwv_flow_imp_shared.create_template_opt_group(
 p_id=>wwv_flow_imp.id(1538066428916652453)
,p_theme_id=>142
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(3183422905554956721)
,p_name=>'ADMINISTRATION'
,p_message_text=>'Administration'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(2586108122739608031)
,p_name=>'HELP'
,p_message_text=>'Help'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(2586100120662607411)
,p_name=>'LOGOUT'
,p_message_text=>'Logout'
,p_version_scn=>37166093867993
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(2694191620832083948)
,p_name=>'USER'
,p_message_text=>'User'
,p_version_scn=>37166093867993
);
...
wwv_flow_imp_shared.create_shortcut(
 p_id=>wwv_flow_imp.id(2668788305748419892)
...
wwv_flow_imp_shared.create_authentication(
 p_id=>wwv_flow_imp.id(8211377037885896731)
,p_name=>'APEX Auth'
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1317475820218270591)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031848814582267073)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031849042723267078)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031849475796267078)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031849840740267078)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031850295432267079)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031850659126267079)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031851074134267079)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031851454008267079)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031851874400267080)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031852240091267080)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(4031852710396267081)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(4031853621461267104)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(4031854394690267112)
,p_plugin_id=>wwv_flow_imp.id(1317475820218270591)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1338189304777845955)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(626807175076581426)
,p_plugin_id=>wwv_flow_imp.id(1338189304777845955)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(626807597946581427)
,p_plugin_id=>wwv_flow_imp.id(1338189304777845955)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1474767196092016749)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180589650880139880)
,p_plugin_id=>wwv_flow_imp.id(1474767196092016749)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(180590064321139880)
,p_plugin_id=>wwv_flow_imp.id(1474767196092016749)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(180591347916139881)
,p_plugin_id=>wwv_flow_imp.id(1474767196092016749)
,p_name=>'SOURCE_SQL'
...
begin
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(180592119152139884)
,p_plugin_id=>wwv_flow_imp.id(1474767196092016749)
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1679211733054264057)
,p_plugin_type=>'REGION TYPE'
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1730521568893865006)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159429875647070435)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_static_id=>'attribute_01'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159430265398070436)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159430731003070436)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159431130960070436)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159431502191070436)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159431849895070436)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159432252890070437)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159432732436070437)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159433074481070437)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>9
,p_display_sequence=>90
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159433524811070437)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>10
,p_display_sequence=>100
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159433852156070437)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>11
,p_display_sequence=>110
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159434282806070437)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(159434668303070438)
,p_plugin_attribute_id=>wwv_flow_imp.id(159434282806070437)
,p_display_sequence=>10
,p_display_value=>'Timeline'
,p_return_value=>'D'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(159435151279070438)
,p_plugin_attribute_id=>wwv_flow_imp.id(159434282806070437)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159435652133070438)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159436109303070438)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
...
,p_column_data_types=>'VARCHAR2'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(159430265398070436)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'NOT_NULL'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(159436457755070439)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(159437760061070440)
,p_plugin_id=>wwv_flow_imp.id(1730521568893865006)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1315447195295621469)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1679211943190269805)
,p_plug_name=>'Footer'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2141252331971713598)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2593838915810695811)
...
,p_list_id=>wwv_flow_imp.id(2593837821184695807)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800230449052743998)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2588322001104860614)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2588322214429860615)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(800230449052743998)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3297580912575933143)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2588322397633860615)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1643346032009326842)
,p_name=>'P3_LASTVIEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2588322001104860614)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2588322817625860622)
,p_name=>'P3_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2588322001104860614)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2588322997481860633)
,p_name=>'P3_TASK_NAME'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(2588322001104860614)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2588323222200860636)
,p_name=>'P3_END_DATE'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_imp.id(2588322001104860614)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2602917900693986156)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3297579906615675953)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3297582327392032016)
,p_name=>'P3_PROJECT'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(2588322001104860614)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(3297583109693074275)
,p_name=>'P3_STATUS'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2588322001104860614)
...
,p_lov=>'.'||wwv_flow_imp.id(2669199507631482917)||'.'
,p_lov_display_null=>'YES'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(1909643887567401242)
...
,p_associated_item=>wwv_flow_imp.id(2588323222200860636)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3294868605137543191)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3294868895342543211)
,p_event_id=>wwv_flow_imp.id(3294868605137543191)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2588323822784860639)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2588324013395860640)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(800230531709743999)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1317511321356254564)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1643344104802326822)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643344213728326823)
,p_name=>'ID'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'ID'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643344233364326824)
,p_name=>'THE_LINK'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643344416339326826)
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643344806922326829)
,p_name=>'COST'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COST'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643344883096326830)
,p_name=>'END_DATE'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643345304784326834)
,p_name=>'PROJECT'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'PROJECT'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643345402950326835)
,p_name=>'STATUS'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'STATUS'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643345446581326836)
,p_name=>'ASSIGNED_TO'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_region_column(
 p_id=>wwv_flow_imp.id(1643345581734326837)
,p_name=>'COLOR'
,p_source_type=>'DB_COLUMN'
,p_data_type=>'COLOR'
,p_session_state_data_type=>'VARCHAR2'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2588735521898944194)
...
,p_plug_display_sequence=>50
,p_plug_display_point=>'REGION_POSITION_01'
,p_menu_id=>wwv_flow_imp.id(8211378338736896741)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>4072363345357175094
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2595223913416882753)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2598934797588360728)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2588735521898944194)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2595224097836882755)
,p_name=>'P4_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2595223913416882753)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2601458527439782993)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3189572919422074795)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2144445033446766108)
,p_plug_name=>'Buttons'
,p_parent_plug_id=>wwv_flow_imp.id(3189572919422074795)
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2603453801827043306)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2144445033446766108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2601524697943786638)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2144445033446766108)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3290965810046268073)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(2144445033446766108)
,p_button_name=>'CANCEL'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2601583415258791633)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2601544703137788198)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2601524697943786638)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2603070200649002911)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2603070613028002914)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2603070695337002914)
,p_name=>'Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603070904892002918)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071003589002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071099739002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071198465002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071321951002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071412324002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071517865002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071599853002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071721618002920)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2603071807074002920)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2603079726452003075)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2603534321566048996)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2603070613028002914)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
...
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_group_id=>wwv_flow_imp.id(671710919778398597)
,p_page_template_options=>'#DEFAULT#'
,p_protection_level=>'C'
,p_help_text=>'No help is available for this page.'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1880018534569375014)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1880018935871375014)
,p_plug_name=>'About this page'
,p_parent_plug_id=>wwv_flow_imp.id(1880018534569375014)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1880019347393375015)
,p_plug_name=>'items'
,p_parent_plug_id=>wwv_flow_imp.id(1880018534569375014)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1880022365945375018)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1880020541763375016)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1880022365945375018)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1880020959645375017)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1880022365945375018)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1880023435204375021)
,p_branch_action=>'f?p=&APP_ID.:settings:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(1880020959645375017)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(988830786951581300)
,p_name=>'P8_ENABLE_USER_STYLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1880019347393375015)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1880019776392375015)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1880022922908375019)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(1880020959645375017)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1317516307906354747)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2204878704664219605)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1338197404271937381)
,p_plug_name=>'SQL Source'
,p_parent_plug_id=>wwv_flow_imp.id(2204878704664219605)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2668792996168419923)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(2668793210887419924)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793306592419930)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793396850419931)
,p_db_column_name=>'ROW_VERSION_NUMBER'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Row Version Number'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793522333419931)
,p_db_column_name=>'PROJECT'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Project'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793609342419932)
,p_db_column_name=>'TASK_NAME'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Task Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793703780419932)
,p_db_column_name=>'START_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793819232419932)
,p_db_column_name=>'END_DATE'
,p_display_order=>6
,p_column_identifier=>'F'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668793917604419933)
,p_db_column_name=>'STATUS'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668794007197419933)
,p_db_column_name=>'ASSIGNED_TO'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Assigned To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668794109245419933)
,p_db_column_name=>'COST'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Cost'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668794208566419933)
,p_db_column_name=>'BUDGET'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Budget'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668875207668435595)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(2668875319079435596)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(2668799219873420154)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2668794522300419934)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2669046109662455064)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2668794522300419934)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:t-Button--iconLeft'
,p_button_template_id=>2082829544945815391
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2668794427430419933)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2668794522300419934)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1643345821666326840)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2668787501537419884)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2668787926818419885)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1643345821666326840)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2668787824218419885)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1643345821666326840)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2668787700801419885)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(1643345821666326840)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(2668788105868419885)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1643345821666326840)
,p_button_name=>'CANCEL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(2668789026426419898)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668789199348419899)
,p_name=>'P10_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2668787501537419884)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668789416014419901)
,p_name=>'P10_PROJECT'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2668787501537419884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668789625730419902)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668789811076419903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668790017405419903)
,p_name=>'P10_END_DATE'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2668787501537419884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668790223774419903)
,p_name=>'P10_STATUS'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(2668787501537419884)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668790425418419903)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668790626606419903)
,p_name=>'P10_COST'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(2668787501537419884)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(2668790799025419905)
,p_name=>'P10_BUDGET'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(2668787501537419884)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(246965967349305712)
,p_name=>'Cancel Modal'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(2668788105868419885)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(246966087428305713)
,p_event_id=>wwv_flow_imp.id(246965967349305712)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2668792005690419912)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2668792202884419914)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(2668792425708419915)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(2668787926818419885)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(2066772421068390926)
,p_name=>'&APP_NAME.'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2066772592635390927)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2066772709267390928)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(2066772751948390929)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258245904164930545)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258246296958930549)
,p_plug_name=>'Quick Start'
,p_parent_plug_id=>wwv_flow_imp.id(3258245904164930545)
,p_plug_display_sequence=>30
,p_plug_display_point=>'SUB_REGIONS'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258246525460930554)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258246703791930554)
,p_plug_name=>'About this Application'
,p_parent_plug_id=>wwv_flow_imp.id(3258245904164930545)
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258247317798930556)
,p_plug_name=>'Help'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1321179501994617852)
,p_plug_name=>'Report'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2100526641005906379
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(1321179715401617852)
,p_name=>'Report'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321179822625617855)
,p_db_column_name=>'ID'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'ID'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321179921332617857)
,p_db_column_name=>'PROJECT'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Project'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180027362617857)
,p_db_column_name=>'TASK_NAME'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Task Name'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180109580617857)
,p_db_column_name=>'START_DATE'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Start Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180212238617857)
,p_db_column_name=>'END_DATE'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'End Date'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180327332617857)
,p_db_column_name=>'STATUS'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Status'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180418658617858)
,p_db_column_name=>'ASSIGNED_TO'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Assigned To'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180513846617858)
,p_db_column_name=>'COST'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'Cost'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(1321180603692617858)
,p_db_column_name=>'BUDGET'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Budget'
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(1321187818649619483)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1321181108690617861)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1321521406884691773)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1321818900744746798)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1321179501994617852)
,p_button_name=>'RESET_REPORT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>2349107722467437027
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1321174707481617828)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1321181414673617861)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1321845123347810070)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1474771009666025638)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1474771197158031424)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1321175222356617829)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1321181414673617861)
,p_button_name=>'CANCEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(1321175525562617829)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321175697085617830)
,p_name=>'P14_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1321845123347810070)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321175921424617840)
,p_name=>'P14_PROJECT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(1321174707481617828)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Project'
,p_source=>'PROJECT'
,p_source_type=>'DB_COLUMN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321176112462617840)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321176315581617840)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321176524362617841)
,p_name=>'P14_END_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(1321174707481617828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321176704561617841)
,p_name=>'P14_STATUS'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_imp.id(1321174707481617828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321176912157617841)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321177112028617841)
,p_name=>'P14_COST'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(1321174707481617828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1321177298950617842)
,p_name=>'P14_BUDGET'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_imp.id(1321174707481617828)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1321178695429617844)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
,p_process_name=>'Process Row of EBA_DEMO_CAL_PROJECTS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1321178899847617844)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1321178517043617843)
,p_process_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1880502632434859258)
...
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(1880504496549859271)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1880503872816859266)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232158540744015)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2660318650330054912)
,p_plug_name=>'Standard Calendars'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(800269143775150185)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800230901175744002)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2494313331670738605)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2494314463480738611)
,p_plug_name=>'Tasks'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2494316434902738695)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noPadding:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796376480897010189)
,p_name=>'P31_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(2494316434902738695)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796378606158010192)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796379081162010193)
,p_event_id=>wwv_flow_imp.id(796378606158010192)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2494314463480738611)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800230685795744000)
,p_name=>'Dialog closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(2494314463480738611)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800230760256744001)
,p_event_id=>wwv_flow_imp.id(800230685795744000)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800230948475744003)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2484936371369016835)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2484937503179016841)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(787001885667288488)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(787002348646288493)
,p_event_id=>wwv_flow_imp.id(787001885667288488)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(2484937503179016841)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(786510989496435124)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231081397744004)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258075173753651985)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3258076305563651991)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(786511025098435125)
,p_name=>'P33_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(786510989496435124)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(786510726525435122)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3258076305563651991)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786510864469435123)
,p_event_id=>wwv_flow_imp.id(786510726525435122)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3258076305563651991)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(786511203821435126)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786511292505435127)
,p_event_id=>wwv_flow_imp.id(786511203821435126)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231124917744005)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1562376215773253188)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4033940400030470049)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4033941531840470055)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796318494224759692)
,p_name=>'P34_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1562376215773253188)
,p_prompt=>'Show Inactive Sessions'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796319703189759694)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4033941531840470055)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796320186097759695)
,p_event_id=>wwv_flow_imp.id(796319703189759694)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4033941531840470055)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796320543242759696)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796321112052759696)
,p_event_id=>wwv_flow_imp.id(796320543242759696)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(796390557193081442)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(796390685310081443)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231269312744006)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2342124801643829303)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4813688985901046164)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4813690117711046170)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796390723738081444)
,p_name=>'P35_SHOW_TIME_FORMAT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2342124801643829303)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(800201714960517777)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800203761129517813)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800204292037517814)
,p_event_id=>wwv_flow_imp.id(800203761129517813)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4813690117711046170)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(627119533271821856)
,p_plug_name=>'Search'
...
,p_filtered_region_id=>wwv_flow_imp.id(3103488380696296065)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1409404818391301456)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3103487248886296059)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3103488380696296065)
,p_plug_name=>'Tasks'
,p_region_name=>'task_due_dates'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(627119617810821857)
,p_name=>'P36_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(627119533271821856)
,p_prompt=>'Search'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(627119735485821858)
,p_name=>'P36_PROJECT'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(627117059050819803)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(627117559153819805)
,p_event_id=>wwv_flow_imp.id(627117059050819803)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3103488380696296065)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(627117953853819806)
,p_name=>'Dialog closed'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3103488380696296065)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(627118504728819806)
,p_event_id=>wwv_flow_imp.id(627117953853819806)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232244999744016)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3440143625019348981)
,p_plug_name=>'Calendars and Dynamic Actions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(800274357641203012)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231320150744007)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3260330131709054834)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3260331263519054840)
,p_plug_name=>'Tasks'
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1562385266962307655)
,p_name=>'Tasks '
,p_parent_plug_id=>wwv_flow_imp.id(3260331263519054840)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796331118392814170)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_hidden_column=>'Y'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796331528539814170)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796331927744814170)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796332362890814171)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796332726871814175)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796333195730814176)
,p_query_column_id=>6
,p_column_alias=>'COST'
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796333573450814176)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796333916478814176)
,p_query_column_id=>8
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(796330735811814168)
,p_query_column_id=>9
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3260333234941054924)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#:t-ButtonRegion--noUI'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796329436453814164)
,p_name=>'P51_PROJECTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3260333234941054924)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796334322373814177)
,p_name=>'P51_CAL_START_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1562385266962307655)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796334771931814177)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796335933666814178)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796336465484814179)
,p_event_id=>wwv_flow_imp.id(796335933666814178)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3260331263519054840)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796336984268814179)
,p_event_id=>wwv_flow_imp.id(796335933666814178)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(1562385266962307655)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796337349855814179)
,p_name=>'Calendar View Changed: Refresh Report'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(3260331263519054840)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendarviewchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796337904449814188)
,p_event_id=>wwv_flow_imp.id(796337349855814179)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796338874915814200)
,p_event_id=>wwv_flow_imp.id(796337349855814179)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796338394180814188)
,p_event_id=>wwv_flow_imp.id(796337349855814179)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796339251108814201)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796339775087814201)
,p_event_id=>wwv_flow_imp.id(796339251108814201)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796340276397814202)
,p_event_id=>wwv_flow_imp.id(796339251108814201)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796340718248814202)
,p_event_id=>wwv_flow_imp.id(796339251108814201)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231428163744008)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1562401189742321427)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4033965373999538288)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4033966505809538294)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(786511910157435133)
,p_name=>'P52_ENDDATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(1562401189742321427)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(786511984055435134)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796343472445827907)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796344663021827909)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4033966505809538294)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796345117120827910)
,p_event_id=>wwv_flow_imp.id(796344663021827909)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4033966505809538294)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796345542837827911)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796346104017827911)
,p_event_id=>wwv_flow_imp.id(796345542837827911)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(786511710994435131)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786511734615435132)
,p_event_id=>wwv_flow_imp.id(786511710994435131)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512105152435135)
,p_event_id=>wwv_flow_imp.id(786511710994435131)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512280323435137)
,p_event_id=>wwv_flow_imp.id(786511710994435131)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512319436435138)
,p_event_id=>wwv_flow_imp.id(786511710994435131)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231562566744009)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2338306658599287209)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4809870842856504070)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4809871974666504076)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(786512686014435141)
,p_name=>'P53_SESSION_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2338306658599287209)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796358623712907387)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796361593055907390)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796362026271907390)
,p_event_id=>wwv_flow_imp.id(796361593055907390)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4809871974666504076)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(786512507801435139)
,p_name=>'Event Clicked: Confirm and Delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4809871974666504076)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512551583435140)
,p_event_id=>wwv_flow_imp.id(786512507801435139)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512786322435142)
,p_event_id=>wwv_flow_imp.id(786512507801435139)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512860489435143)
,p_event_id=>wwv_flow_imp.id(786512507801435139)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786512983009435144)
,p_event_id=>wwv_flow_imp.id(786512507801435139)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232622799744020)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3118157117503872103)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5589721301761088964)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5589722433571088970)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(800303937138526502)
,p_name=>'P54_SHOW_INACTIVE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3118157117503872103)
,p_prompt=>'Show Inactive Sessions'
,p_display_as=>'NATIVE_YES_NO'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(800304336322526511)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800305001032526512)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800305431932526516)
,p_event_id=>wwv_flow_imp.id(800305001032526512)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5589722433571088970)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800305821653526517)
,p_name=>'Event Clicked: Confirm and Delete'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5589722433571088970)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800307873516526519)
,p_event_id=>wwv_flow_imp.id(800305821653526517)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800306818347526518)
,p_event_id=>wwv_flow_imp.id(800305821653526517)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800307324885526518)
,p_event_id=>wwv_flow_imp.id(800305821653526517)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232398542744017)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4219973942957696279)
,p_plug_name=>'Calendars and Javascript'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(800279521499261016)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231634664744010)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3270243694358869175)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3270244826168869181)
,p_plug_name=>'Tasks'
,p_region_name=>'project_tasks'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3270246797590869265)
,p_plug_name=>'Button Bar'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(796390259701081439)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3270246797590869265)
,p_button_name=>'TODAY'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(786513075045435145)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3270246797590869265)
,p_button_name=>'NEXT'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(796386306163081399)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3270246797590869265)
,p_button_name=>'PREV'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796383539531072175)
,p_name=>'P71_PROJECTS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(3270246797590869265)
,p_item_default=>'0'
,p_prompt=>'Project'
,p_source=>'0'
,p_source_type=>'STATIC'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796386796378081404)
,p_name=>'P71_GOTODATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(3270246797590869265)
,p_prompt=>'Goto date'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796388324095081420)
,p_name=>'P71_VIEWTYPE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(3270246797590869265)
,p_prompt=>'View Type'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796384719640072177)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796385290387072177)
,p_event_id=>wwv_flow_imp.id(796384719640072177)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3270244826168869181)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(786513209523435146)
,p_name=>'Calendar: Next Month'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(786513075045435145)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796386078278081397)
,p_event_id=>wwv_flow_imp.id(786513209523435146)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796386608884081402)
,p_name=>'Calendar: Prev Month'
,p_event_sequence=>30
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(796386306163081399)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796386685923081403)
,p_event_id=>wwv_flow_imp.id(796386608884081402)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796386836089081405)
,p_name=>'Focus Date'
,p_event_sequence=>40
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796386920785081406)
,p_event_id=>wwv_flow_imp.id(796386836089081405)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796387252914081409)
,p_event_id=>wwv_flow_imp.id(796386836089081405)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796388458889081421)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796388599936081422)
,p_event_id=>wwv_flow_imp.id(796388458889081421)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796388643353081423)
,p_name=>'Change View'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796388735896081424)
,p_event_id=>wwv_flow_imp.id(796388643353081423)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796390408442081440)
,p_name=>'Set Goto Date to "today"'
,p_event_sequence=>70
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(796390259701081439)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796390455212081441)
,p_event_id=>wwv_flow_imp.id(796390408442081440)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231795942744011)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4046200556309191849)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4046201688119191855)
,p_plug_name=>'Tasks'
,p_region_name=>'project_tasks'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4046203659541191939)
,p_plug_name=>'Button Bar'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796387338638081410)
,p_name=>'P72_END_DATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(4046203659541191939)
,p_prompt=>'to'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_begin_on_new_line=>'N'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796387433141081411)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796410846436264278)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796412447380264281)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796413002357264282)
,p_event_id=>wwv_flow_imp.id(796412447380264281)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4046201688119191855)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796413412135264282)
,p_name=>'Calendar: Next Month'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(786513075045435145)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796413910890264283)
,p_event_id=>wwv_flow_imp.id(796413412135264282)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796387571349081412)
,p_name=>'Get Calendar Status'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4046201688119191855)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendarviewchange'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796387617540081413)
,p_event_id=>wwv_flow_imp.id(796387571349081412)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796387750620081414)
,p_event_id=>wwv_flow_imp.id(796387571349081412)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796387862956081415)
,p_event_id=>wwv_flow_imp.id(796387571349081412)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800230368201743997)
,p_event_id=>wwv_flow_imp.id(796387571349081412)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231910989744012)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2338458876204817624)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>20
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4810023060462034485)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4810024192272034491)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(796389128709081428)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(2338458876204817624)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(796389704082081433)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(2338458876204817624)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796389074538081427)
,p_name=>'P73_TITLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(2338458876204817624)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796389577763081432)
...
,p_lov=>'.'||wwv_flow_imp.id(796306620013716604)||'.'
,p_cHeight=>1
,p_begin_on_new_line=>'N'
,p_field_template=>3031561666792084173
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796511293428437810)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(796511682283437810)
,p_name=>'P73_ENDDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(2338458876204817624)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796514632653437814)
,p_name=>'Date Range Selected: Create new Event'
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4810024192272034491)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendardateselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796515121051437814)
,p_event_id=>wwv_flow_imp.id(796514632653437814)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796515695858437815)
,p_event_id=>wwv_flow_imp.id(796514632653437814)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796389506872081431)
,p_event_id=>wwv_flow_imp.id(796514632653437814)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
,p_affected_button_id=>wwv_flow_imp.id(796389128709081428)
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796389293960081429)
,p_name=>'Create Javascript Event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(796389128709081428)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796389399167081430)
,p_event_id=>wwv_flow_imp.id(796389293960081429)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796389732061081434)
,p_name=>'Save Event to Database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(796389704082081433)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796389872840081435)
,p_event_id=>wwv_flow_imp.id(796389732061081434)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796389989414081436)
,p_event_id=>wwv_flow_imp.id(796389732061081434)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4810024192272034491)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796390022300081437)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796390175125081438)
,p_event_id=>wwv_flow_imp.id(796390022300081437)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232756055744021)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(903153544613636332)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3122340250201815909)
,p_plug_name=>'Items Container'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>30
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5593904434459032770)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5593905566269032776)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(804334826634939972)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(3122340250201815909)
,p_button_name=>'SHOW_IN_CALENDAR'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(804335217006939974)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(3122340250201815909)
,p_button_name=>'SAVE_IN_DATABASE'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(804382818287548598)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(3122340250201815909)
,p_button_name=>'CLEAR'
,p_button_action=>'DEFINED_BY_DA'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(800233062510744024)
,p_name=>'P74_MY_SESSION_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(800232756055744021)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(804335647562939974)
,p_name=>'P74_TITLE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(3122340250201815909)
,p_item_default=>'My Session'
,p_prompt=>'Title'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(804336429306939982)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(804336886900939983)
,p_name=>'P74_ENDDATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(3122340250201815909)
,p_item_default=>'to_char(sysdate, ''YYYY-MM-DD'')||'' 11:00:00'''
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(804342579955940030)
,p_name=>'Create Javascript Event'
,p_event_sequence=>40
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(804334826634939972)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804343113078940030)
,p_event_id=>wwv_flow_imp.id(804342579955940030)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(804337460206940015)
,p_name=>'Save Event to Database'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(804335217006939974)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804337973607940019)
,p_event_id=>wwv_flow_imp.id(804337460206940015)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804338484600940024)
,p_event_id=>wwv_flow_imp.id(804337460206940015)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(800232756055744021)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(988830892164581301)
,p_event_id=>wwv_flow_imp.id(804337460206940015)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(804338878700940024)
,p_name=>'Event Data Changed: Show in Calendar'
,p_event_sequence=>60
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804339327948940027)
,p_event_id=>wwv_flow_imp.id(804338878700940024)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(804334826634939972)
,p_attribute_01=>'apex.event.trigger(this.affectedElements, "click");'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800232886701744022)
,p_name=>'Event selected: Copy to "My Sessions"'
,p_event_sequence=>70
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5593905566269032776)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'NATIVE_CSS_CALENDAR|REGION TYPE|apexcalendareventselect'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800233324824744027)
,p_event_id=>wwv_flow_imp.id(800232886701744022)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800232946317744023)
,p_event_id=>wwv_flow_imp.id(800232886701744022)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800233288604744026)
,p_event_id=>wwv_flow_imp.id(800232886701744022)
,p_event_result=>'TRUE'
,p_action_sequence=>50
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800233475050744028)
,p_event_id=>wwv_flow_imp.id(800232886701744022)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800233592855744029)
,p_name=>'Delete Selected Event'
,p_event_sequence=>80
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(800232756055744021)
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800233798021744031)
,p_event_id=>wwv_flow_imp.id(800233592855744029)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800233818543744032)
,p_event_id=>wwv_flow_imp.id(800233592855744029)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800233955743744033)
,p_event_id=>wwv_flow_imp.id(800233592855744029)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800234056827744034)
,p_event_id=>wwv_flow_imp.id(800233592855744029)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800234206420744035)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800234273962744036)
,p_event_id=>wwv_flow_imp.id(800234206420744035)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800234340243744037)
,p_event_id=>wwv_flow_imp.id(800234206420744035)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800234480918744038)
,p_event_id=>wwv_flow_imp.id(800234206420744035)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(800235170695744045)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(800235244294744046)
,p_event_id=>wwv_flow_imp.id(800235170695744045)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(5593905566269032776)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(804382989041548599)
,p_name=>'Clear Schedule'
,p_event_sequence=>110
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(804382818287548598)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804383107160548600)
,p_event_id=>wwv_flow_imp.id(804382989041548599)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CONFIRM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804383147961548601)
,p_event_id=>wwv_flow_imp.id(804382989041548599)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804383234663548602)
,p_event_id=>wwv_flow_imp.id(804382989041548599)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804383375776548603)
,p_event_id=>wwv_flow_imp.id(804382989041548599)
,p_event_result=>'TRUE'
,p_action_sequence=>40
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(804383678320548606)
,p_name=>'Change topic'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(804383728867548607)
,p_event_id=>wwv_flow_imp.id(804383678320548606)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(2110028364494231201)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2110028461945231202)
,p_event_id=>wwv_flow_imp.id(2110028364494231201)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(627119830032821859)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(627119942107821860)
,p_event_id=>wwv_flow_imp.id(627119830032821859)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232471191744018)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4999809084359079405)
,p_plug_name=>'Calendar Styling'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(800285161730306214)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800231930858744013)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3260964918323206686)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(3260966050133206692)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796482687129131507)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796483186483131513)
,p_event_id=>wwv_flow_imp.id(796482687129131507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(3260966050133206692)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(800232076664744014)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4037000305439483452)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4037001437249483458)
,p_plug_name=>'Sessions'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(796489079545218374)
,p_name=>'Change Project - Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(796489529403218375)
,p_event_id=>wwv_flow_imp.id(796489079545218374)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4037001437249483458)
,p_attribute_01=>'N'
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8211377534692896735)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(3145387007341479254)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(8211377534692896735)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8211377647295896739)
,p_name=>'P101_USERNAME'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(8211377534692896735)
,p_prompt=>'Username'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8211377747021896739)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(3261838297550439014)
,p_name=>'Set Focus'
,p_event_sequence=>10
,p_triggering_condition_type=>'JAVASCRIPT_EXPRESSION'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3261838618956439015)
,p_event_id=>wwv_flow_imp.id(3261838297550439014)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(3261838798828439015)
,p_event_id=>wwv_flow_imp.id(3261838297550439014)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8211378022207896741)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8211377929111896740)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8211378224031896741)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8211378119713896741)
,p_process_sequence=>10
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(811461125225592728)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5057581288293260520)
,p_plug_name=>'Custom Calendar Initialization'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hiddenOverflow:t-Region--hideHeader js-addHiddenHeadingRoleDesc'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>4072358936313175081
,p_plug_display_sequence=>20
,p_list_id=>wwv_flow_imp.id(858060446226512830)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>2067994871570597190
);
end;
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(811461216588592729)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4871558250796972289)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(4871559382606972295)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(858047869253375604)
,p_name=>'Dialog Closed: Refresh Calendar'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(4871559382606972295)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(858048378062375604)
,p_event_id=>wwv_flow_imp.id(858047869253375604)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(4871559382606972295)
,p_attribute_01=>'N'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(858048769083375605)
,p_name=>'Change Show Inactive Sessions'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(858049272972375605)
,p_event_id=>wwv_flow_imp.id(858048769083375605)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(830299691766077288)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>2531463326621247859
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5753069048083613167)
,p_plug_name=>'About this page'
,p_region_template_options=>'#DEFAULT#:margin-bottom-md'
,p_plug_template=>4501440665235496320
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5753070179893613173)
,p_plug_name=>'Sessions'
,p_region_template_options=>'#DEFAULT#:t-Region--noPadding:t-Region--hideHeader js-addHiddenHeadingRoleDesc:t-Region--hiddenOverflow'
,p_escape_on_http_output=>'Y'
,p_plug_template=>4072358936313175081
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(956610201673396343)
,p_name=>'P112_DRAGDROP_MSG'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(5753070179893613173)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(956609756190396339)
,p_name=>'Begin Drag & Drop '
,p_event_sequence=>30
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(5753070179893613173)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(956609912526396340)
,p_event_id=>wwv_flow_imp.id(956609756190396339)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(956609930129396341)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(956610029529396342)
,p_event_id=>wwv_flow_imp.id(956609930129396341)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(988830541402581298)
,p_event_id=>wwv_flow_imp.id(956609930129396341)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(793593888888584248)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(793594586038584249)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>2126429139436695430
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(793594995892584250)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(793594586038584249)
,p_button_name=>'CANCEL'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>4072362960822175091
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(793594463581584249)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(793594586038584249)
,p_button_name=>'DELETE'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(793594412803584249)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(793594586038584249)
,p_button_name=>'SAVE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(793594260838584249)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(793594586038584249)
,p_button_name=>'CREATE'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793597375765584259)
,p_name=>'P301_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(793593888888584248)
,p_use_cache_before_default=>'NO'
,p_source=>'ID'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793597776672584293)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793598061658584297)
,p_name=>'P301_TITLE'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(793593888888584248)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793598500791584297)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793598858028584298)
,p_name=>'P301_SPEAKER'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(793593888888584248)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793599227901584298)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793599699896584298)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(793600071282584299)
,p_name=>'P301_STATUS'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_imp.id(793593888888584248)
...
,p_named_lov=>'STATUS'
,p_lov=>'.'||wwv_flow_imp.id(340904421072829843)||'.'
,p_field_template=>2526760615038828570
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(793595024393584250)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(793594995892584250)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(793595858241584253)
,p_event_id=>wwv_flow_imp.id(793595024393584250)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_DIALOG_CANCEL'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(786511409668435128)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786511462436435129)
,p_event_id=>wwv_flow_imp.id(786511409668435128)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(786511576156435130)
,p_event_id=>wwv_flow_imp.id(786511409668435128)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(793600907390584305)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(793601272084584306)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_FORM_PROCESS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(793601639825584306)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_imp.id(793594463581584249)
,p_internal_uid=>775660993182322051
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(793602087538584306)
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(2583409321684055959)
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(3360215705265137912)
,p_install_id=>wwv_flow_imp.id(2583409321684055959)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(2587330710937727706)
,p_install_id=>wwv_flow_imp.id(2583409321684055959)
...
begin
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(2587402095830732720)
,p_install_id=>wwv_flow_imp.id(2583409321684055959)
,p_name=>'insert data'
,p_sequence=>30
,p_script_type=>'INSTALL'
